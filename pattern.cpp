...
{ LFS
  ...
  if (ts>=0)
    ...
    {
      if (its->isPattern)
        ::lplog(logType,L"TAGSET %05d: %03d %s[%s] %s[%s](%d,%d) TAG %s [%d,%d]",ts,its->sourcePosition,patterns[its->parentPattern]->name.c_str(),patterns[its->parentPattern]->differentiator.c_str(),
        ...
        ::lplog(logType,L"TAGSET %05d: %03d %s[%s] %s(%d,%d) TAG %s [%d,%d]",ts,its->sourcePosition,patterns[its->parentPattern]->name.c_str(),patterns[its->parentPattern]->differentiator.c_str(),
