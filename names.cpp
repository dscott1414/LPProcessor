...
// Copy every name part and nickName. tIWMM copies are iterator copies.
...
// Look firstName up in nicknameEquivalenceMap (US Census clusters).
// Sets nickName to the class id. False if the name is not in the map.
